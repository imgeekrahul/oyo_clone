            ...
            <div className='flex justify-center items-center w-9/12'>
                ...
                <div className='ml-20 pb-40 w-10/12 border bg-slate-50'>
                    ...
                    <div className='px-10'>
                        ...
                        <button type="submit" className='w-96 h-14 text-lg font-bold bg-red-500 hover:cursor-pointer hover:bg-red-600 text-white my-5 rounded-lg' onClick={login ? handleLogin : handleSignup} >{login ? "Login" : "Sign up"}</button>
