...
const Header3 = () => {
  return (
    <div className='bg-gradient-to-r from-red-600 to-red-400 h-60'>
        <div className='p-5'>
            <h2 className='text-4xl text-center text-white font-bold'>Over 157,000 hotels and homes across 35 countries</h2>
            <div className='grid grid-cols-5 my-5 mx-20'>
                ...
                <Link href="/hotels">
                  <button href="/hotels" type='submit' className='w-full h-16 px-3 py-2 col-span-1 bg-green-400 hover:cursor-pointer hover:bg-green-600 text-white text-xl'>Search</button>
                </Link>
            </div>
            <div className='flex mx-20 my-5 font-bold'>
                ...
                <button type="submit" className='h-16 px-3 py-2 hover:cursor-pointer border-2 border-white text-white mr-5 rounded-xl hover:bg-slate-500'>Homestay in India hotels</button>
            </div>
        </div>
    </div>
  )
